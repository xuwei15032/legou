...
<body>
	<!-- header -->
	<div class="header">
		<a href="http://www.legou.cn"><img src="/images/logo.png" border="0"><span>欢迎登录</span></a>
	</div>
	<!-- login_main -->
	<div class="login_main clear">
		<div class="pic">
			<a href="http://www.legou.cn/html/activity/1472720729.html" target="_blank"><img src="/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
		</div>
		<!-- login -->
		<div class="login">
					...
					<form id="formlogin" method="post" >
						...
						<li>
							<div style="width: 65px; margin-left: 260px;">
								<a href="https://passport.legou.cn/reg/findpass/?returnUrl=http://www.legou.cn" class="forget-passWord">忘记密码?</a>
							</div>
						</li>
	...
	<div class="footer">
		...
		<p>
			<a href="http://www.miibeian.gov.cn" target="_blank" rel="nofollow" class="footerlink1">京ICP备12011349号</a>|<a href="http://www.legou.cn/www/174/461.html" target="_blank" rel="nofollow" class="footerlink1">企业营业执照</a><br> Copyright© 乐购网商城
			legou.cn 版权所有<br>
		</p>
	</div>
	<!-- /footer -->
