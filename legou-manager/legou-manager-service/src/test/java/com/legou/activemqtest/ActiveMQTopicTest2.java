...
public class ActiveMQTopicTest2 {
	...
	public void testQueueProducerHaotian() throws Exception {
		...
		MessageProducer zhaohaotian = session.createProducer(topic);
	...
	// 消费者 接受消息
	@Test
	public void testTopicConsumerLili() throws Exception {
		...
		// 创建消费者
		MessageConsumer lili = session.createConsumer(topic);
